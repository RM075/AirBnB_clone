...
```bash
git clone https://github.com/RM075/AirBnB_clone.git
```
...
* [0-index.html](https://github.com/RM075/AirBnB_clone.git/web_static/)
...
> *Console team: Roderick Meraner*
> *Web Static: Roderick Meraner*
